...
//    private String language;
    ...
    public String requestWebPageXrel(ApiUrlXrel apiUrl, String jsonBody, RequestMethod requestMethod) throws MalformedURLException {
        return requestWebPageInternalXrel(apiUrl, jsonBody, requestMethod);
    }
    ...
    private String requestWebPageInternalXrel(ApiUrlXrel apiUrl, String jsonBody, RequestMethod requestMethod) throws MalformedURLException {
        try {
            return urlReader.request(new URL(apiUrl.getBaseUrl()), jsonBody, requestMethod);
